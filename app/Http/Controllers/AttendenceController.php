...
class AttendenceController extends Controller
{
    ...
    public function show(Request $request, $employee_id)
    {
      ...
      if($request->all()){
        ...
        $data['date_range']=$date_range['days'];
        $data['start_date']=$date_range['start_date'];
        $data['end_date']=$date_range['end_date'];
      }
    ...
    public function attenedence_daily_monthly(request $request)
    {
      ...
      // var_dump($request->all());
        ...
        $employees=Employees::where('branch_id',$request->branch_id)->get();
        $employees_attendence_data=array();
